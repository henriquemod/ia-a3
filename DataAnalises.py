...
# NOTE - Plotando a correlação entre a saída(income) e as características
# SECTION
# plt.matshow(df.corr())
# plt.colorbar()
...
# Dividindo as horas de trabalho em 3 grandes intervalos e plotando-as correspondentes ao atributo de saída(income)
...
# Como a maioria dos países é americano, combinamos os outros países em um único grupo
